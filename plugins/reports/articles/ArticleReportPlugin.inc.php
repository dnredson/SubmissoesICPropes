	...
	function display($args, $request) {
		...
		while ($submission = $submissions->next()) {
			...
			$results[] = [
				...
				'nomeAluno' => html_entity_decode(strip_tags($publication->getLocalizedData('nomeAluno'))),
				'RAAluno' => html_entity_decode(strip_tags($publication->getLocalizedData('RAAluno'))),
				'emailAluno' => html_entity_decode(strip_tags($publication->getLocalizedData('emailAluno'))),
				'modalidadeAluno' => html_entity_decode(strip_tags($publication->getLocalizedData('modalidadeAluno'))),
				'nomeOrientador' => html_entity_decode(strip_tags($publication->getLocalizedData('nomeOrientador'))),
				'emailOrientador' => html_entity_decode(strip_tags($publication->getLocalizedData('emailOrientador'))),
				'filhoEmIdadePreFundamental' => html_entity_decode(strip_tags($publication->getLocalizedData('filhoEmIdadePreFundamental'))),
				'bolsistaProdutividade' => html_entity_decode(strip_tags($publication->getLocalizedData('bolsistaProdutividade'))),
				'orientacaoDoutoradoConcluida' => html_entity_decode(strip_tags($publication->getLocalizedData('orientacaoDoutoradoConcluida'))),
				'orientacaoMestradoConcluida' => html_entity_decode(strip_tags($publication->getLocalizedData('orientacaoMestradoConcluida'))),
				'credenciadoEmPos' => html_entity_decode(strip_tags($publication->getLocalizedData('credenciadoEmPos'))),
				'notaCapesProgramaPos' => html_entity_decode(strip_tags($publication->getLocalizedData('notaCapesProgramaPos'))),
				'PGCTA' => html_entity_decode(strip_tags($publication->getLocalizedData('PGCTA'))),
				'sisgen' => html_entity_decode(strip_tags($publication->getLocalizedData('sisgen'))),
				'areaSubarea' => html_entity_decode(strip_tags($publication->getLocalizedData('areaSubarea'))),
				'eixo' => html_entity_decode(strip_tags($publication->getLocalizedData('eixo'))),
				'naoRevisor' => html_entity_decode(strip_tags($publication->getLocalizedData('naoRevisor'))),
		...
		$columns = [
			...
			__('common.nomeAluno'),
			__('common.RAAluno'),
			__('common.emailAluno'),
			__('common.modalidadeAluno'),
			__('common.nomeOrientador'),
			__('common.emailOrientador'),
			__('common.filhoEmIdadePreFundamental'),
			__('common.bolsistaProdutividade'),
			__('common.orientacaoDoutoradoConcluida'),
			__('common.orientacaoMestradoConcluida'),
			__('common.credenciadoEmPos'),
			__('common.notaCapesProgramaPos'),
			__('common.PGCTA'),
			__('common.sisgen'),
			__('common.areaSubarea'),
			__('common.eixo'),
			__('common.naoRevisor')
		];
