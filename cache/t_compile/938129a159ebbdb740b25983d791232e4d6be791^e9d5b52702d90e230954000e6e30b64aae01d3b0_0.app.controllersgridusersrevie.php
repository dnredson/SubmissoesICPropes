<?php
/* Smarty version 3.1.39, created on 2022-07-05 18:13:14
  from 'app:controllersgridusersrevie' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62c47f3aed2712_47294334',
...
function content_62c47f3aed2712_47294334 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin1->smartyFBVFormSection(array('title'=>"stageParticipants.notify.chooseMessage",'for'=>"template",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['medium']), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin1->smartyFBVFormSection(array('title'=>"stageParticipants.notify.chooseMessage",'for'=>"template",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['medium']), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin2->smartyFBVFormSection(array('title'=>"editor.review.personalMessageToReviewer",'for'=>"personalMessage"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin2->smartyFBVFormSection(array('title'=>"editor.review.personalMessageToReviewer",'for'=>"personalMessage"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin3->smartyFBVFormSection(array('for'=>"skipEmail",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM'],'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin3->smartyFBVFormSection(array('for'=>"skipEmail",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM'],'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin4->smartyFBVFormSection(array('title'=>"editor.review.importantDates"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin4->smartyFBVFormSection(array('title'=>"editor.review.importantDates"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin5->smartyFBVFormSection(array('list'=>true,'title'=>"editor.submissionReview.reviewType"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	<?php $_block_repeat=false;
echo $_block_plugin5->smartyFBVFormSection(array('list'=>true,'title'=>"editor.submissionReview.reviewType"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin6->smartyFBVFormSection(array('title'=>"submission.reviewForm"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin6->smartyFBVFormSection(array('title'=>"submission.reviewForm"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
