...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6290e64af14b35_94229583',
...
function content_6290e64af14b35_94229583 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin21->smartyFBVFormArea(array('id'=>"additionalDublinCore",'title'=>"submission.metadata"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin22->smartyFBVFormSection(array('description'=>"submission.metadataDescription"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			
		<?php $_block_repeat=false;
echo $_block_plugin22->smartyFBVFormSection(array('description'=>"submission.metadataDescription"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin23->smartyFBVFormSection(array('title'=>"submission.coverage",'for'=>"coverage",'required'=>$_smarty_tpl->tpl_vars['coverageRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin23->smartyFBVFormSection(array('title'=>"submission.coverage",'for'=>"coverage",'required'=>$_smarty_tpl->tpl_vars['coverageRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin24->smartyFBVFormSection(array('for'=>"type",'title'=>"common.type",'required'=>$_smarty_tpl->tpl_vars['typeRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin24->smartyFBVFormSection(array('for'=>"type",'title'=>"common.type",'required'=>$_smarty_tpl->tpl_vars['typeRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin25->smartyFBVFormSection(array('label'=>"submission.source",'for'=>"source",'required'=>$_smarty_tpl->tpl_vars['sourceRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin25->smartyFBVFormSection(array('label'=>"submission.source",'for'=>"source",'required'=>$_smarty_tpl->tpl_vars['sourceRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin26->smartyFBVFormSection(array('label'=>"submission.rights",'for'=>"rights",'required'=>$_smarty_tpl->tpl_vars['rightsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin26->smartyFBVFormSection(array('label'=>"submission.rights",'for'=>"rights",'required'=>$_smarty_tpl->tpl_vars['rightsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin21->smartyFBVFormArea(array('id'=>"additionalDublinCore",'title'=>"submission.metadata"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}?>
...
$_block_repeat=true;
echo $_block_plugin27->smartyFBVFormArea(array('id'=>"tagitFields",'title'=>"submission.submit.metadataForm"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin28->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.subjects",'required'=>$_smarty_tpl->tpl_vars['subjectsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin28->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.subjects",'required'=>$_smarty_tpl->tpl_vars['subjectsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin29->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"search.discipline",'required'=>$_smarty_tpl->tpl_vars['disciplinesRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin29->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"search.discipline",'required'=>$_smarty_tpl->tpl_vars['disciplinesRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin30->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.keywords",'required'=>$_smarty_tpl->tpl_vars['keywordsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin30->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.keywords",'required'=>$_smarty_tpl->tpl_vars['keywordsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['agenciesEnabled']->value) {?>
			<?php $_block_plugin31 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin31->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"submission.supportingAgencies",'required'=>$_smarty_tpl->tpl_vars['agenciesRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin31->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"submission.supportingAgencies",'required'=>$_smarty_tpl->tpl_vars['agenciesRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['citationsEnabled']->value) {?>
			<?php $_block_plugin32 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0] : null;
if (!is_callable(array($_block_plugin32, 'smartyFBVFormSection'))) {
throw new SmartyException('block tag \'fbvFormSection\' not callable or registered');
}
...
$_block_repeat=true;
echo $_block_plugin32->smartyFBVFormSection(array('label'=>"submission.citations",'required'=>$_smarty_tpl->tpl_vars['citationsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin32->smartyFBVFormSection(array('label'=>"submission.citations",'required'=>$_smarty_tpl->tpl_vars['citationsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin27->smartyFBVFormArea(array('id'=>"tagitFields",'title'=>"submission.submit.metadataForm"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}?>
