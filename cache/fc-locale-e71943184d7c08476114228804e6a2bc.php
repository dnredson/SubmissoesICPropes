<?php return array (
  'admin.settings.disableBulkEmailRoles.label' => 'Desativar Emails em Massa',
  'admin.settings.restrictBulkEmails' => 'Configurações de email em massa',
  'admin.settings.enableBulkEmails.label' => 'Ativar Emails em Massa',
