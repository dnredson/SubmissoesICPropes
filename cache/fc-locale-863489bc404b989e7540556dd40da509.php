<?php return array (
  ...
  'manager.people.signedInAs' => 'Logado como',
  ...
  'manager.announcements' => 'Anúncios',
  'manager.announcements.confirmDelete' => 'Deseja realmente excluir permanentemente o anúncio {$title}?',
  'manager.announcements.create' => 'Criar novo anúncio',
  ...
  'manager.announcements.noneCreated' => 'Não há anúncios criados.',
  'manager.announcements.title' => 'Título',
  'manager.announcements.type' => 'Tipo',
  'manager.announcementTypes' => 'Tipos de notícia',
  'manager.announcementTypes.confirmDelete' => 'Aviso! Todos os anúncios deste tipo serão excluídos. Deseja realmente continuar e excluir este tipo de anúncio?',
  'manager.announcementTypes.create' => 'Criar Tipo de Anúncio',
  ...
  'manager.setup.dateTime' => 'Data/Hora',
...
Há casos em que uma única estatística de uso devem ser utilizada, por exemplo, para exibir uma lista ordenada de submissões mais utilizados ou para classificação de resultados da pesquisa. Por favor selecione uma das métricas configuradas como padrão.
  ...
  'manager.navigationMenus.announcements.description' => 'Link para a página exibindo seus anúncios.',
  'manager.navigationMenus.announcements.conditionalWarning' => 'Este link apenas será exibido se você tiver habilitado a aba anúncios em Configurações > Website.',
  ...
  'manager.setup.reviewOptions.showAnonymousReviewLink' => 'Apresentar link <button type="button">Garantindo uma Avaliação Cega</button> durante a transferência',
